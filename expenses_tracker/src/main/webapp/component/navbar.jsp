...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="view_expense.jsp" tabindex="-1"> <i class="fa-solid fa-list"></i>View Expenses</a>
        </li>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="register.jsp" tabindex="-1"> <i class="fa-solid fa-registered"></i>Register</a>
        </li>
           </c:if>
      </ul>
